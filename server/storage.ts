  ...
  private initializeData() {
    ...
    const ingredientsData: InsertIngredient[] = [
      ...
      },
      {
        ...
        effects: ["補中益気", "生津潤燥", "通便"],
        contraindications: ["湿痰壅盛者慎用"],
        nutrition: { calories: 132, fiber: 2.3, betaCarotene: 23000 },
        commonUses: ["焼き芋", "煮物", "天ぷら"],
      ...
      },
      {
        ...
        contraindications: [],
        nutrition: { calories: 23, protein: 1.8, folate: 16 },
        commonUses: ["炒め物", "煮物", "サラダ"],
      ...
      // う行
      {
        ...
        nutrition: { calories: 18, potassium: 220, fiber: 1.4 },
        commonUses: ["酢の物", "天ぷら", "炒め物"],
      ...
      },
      {
        ...
        effects: ["斂肺止咳", "渋腸止瀉", "安蛔"],
        contraindications: ["感冒発熱者忌用"],
        nutrition: { calories: 28, citric_acid: "高含有", vitaminE: 0.9 },
        commonUses: ["梅干し", "梅酒", "調味料"],
        preparationMethods: ["塩漬け", "砂糖漬け", "酒漬け"],
        bestSeasons: ["summer"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        effects: ["清熱除煩", "利水通淋", "解毒"],
        contraindications: ["脾胃虚寒者慎用"],
        nutrition: { calories: 32, water: 90.0, potassium: 350 },
        commonUses: ["生食", "漬物", "サラダ"],
        preparationMethods: ["生食", "漬ける"],
        bestSeasons: ["summer"],
        synergisticWith: [],
        conflictsWith: []
      },
      ...
      // か行継続
      {
        ...
        effects: ["補中益気", "健脾和胃"],
        contraindications: [],
        nutrition: { calories: 228, protein: 15.3, calcium: 270 },
        commonUses: ["煮物", "おでん", "炒め物"],
      ...
      },
      {
        ...
        commonUses: ["焼き魚", "炊き込みご飯"],
        preparationMethods: ["焼く", "炊く"],
        bestSeasons: ["autumn"],
        synergisticWith: [],
        conflictsWith: []
      },
      ...
      },
      {
        ...
        meridians: ["spleen", "stomach"],
        effects: ["温中補虚", "益気填髄"],
        contraindications: ["発熱者忌用"],
        nutrition: { calories: 290, protein: 18.6, fat: 21.9 },
        commonUses: ["お弁当", "定食", "おつまみ"],
        preparationMethods: ["揚げる"],
        bestSeasons: ["all"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        effects: ["健脾補虚", "益気和中"],
        contraindications: [],
        nutrition: { calories: 95, protein: 19.6, taurine: "含有" },
      ...
      // き行継続
      {
        ...
        effects: ["補気血", "潤燥", "涼血止血"],
        contraindications: [],
        nutrition: { calories: 13, iron: 0.7, calcium: 82, fiber: 7.4 },
        commonUses: ["炒め物", "スープ", "酢の物"],
        preparationMethods: ["水で戻す", "炒める", "茹でる"],
        bestSeasons: ["all"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        element: "fire",
        meridians: ["spleen", "kidney"],
        effects: ["補腎壮陽", "益精血", "強筋骨"],
        contraindications: [],
        nutrition: { calories: 160, protein: 17.8, EPA_DHA: "高含有" },
        commonUses: ["煮付け", "刺身", "塩焼き"],
        preparationMethods: ["煮る", "焼く", "生食"],
        bestSeasons: ["winter"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        effects: ["理気解郁", "止咳化痰", "消食開胃"],
        contraindications: ["陰虚体質者慎用"],
        nutrition: { calories: 71, vitaminC: 49, hesperidin: "高含有" },
        commonUses: ["生食", "砂糖漬け", "茶"],
        preparationMethods: ["生食", "砂糖漬け", "煎じる"],
        bestSeasons: ["winter"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        effects: ["斂肺定喘", "止帯濁", "縮小便"],
        contraindications: ["小児多食禁忌", "生食禁忌"],
        nutrition: { calories: 187, carbohydrates: 38.0, ginkgotoxin: "含有" },
        commonUses: ["茶碗蒸し", "炒め物", "串焼き"],
        preparationMethods: ["茹でる", "炒める", "焼く"],
        bestSeasons: ["autumn"],
        synergisticWith: [],
        conflictsWith: []
      },
      ...
      // く行継続
      {
        ...
        effects: ["清熱除煩", "涼血解毒", "利湿退黄"],
        contraindications: ["脾胃虚寒者忌用"],
        nutrition: { crocetin: "含有", geniposide: "含有" },
        commonUses: ["色付け", "薬用茶"],
        preparationMethods: ["煎じる", "浸出"],
        bestSeasons: ["summer"],
        synergisticWith: [],
      ...
      },
      {
        ...
        effects: ["補腎壮陽", "益精血", "強筋骨"],
        contraindications: ["現在入手困難"],
        nutrition: { calories: 106, protein: 23.1, iron: 2.5 },
        commonUses: ["刺身", "竜田揚げ"],
        preparationMethods: ["生食", "揚げる"],
        bestSeasons: ["winter"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        element: "earth",
        meridians: ["spleen", "stomach"],
        effects: ["清熱生津", "解肌退熱", "透疹"],
        contraindications: ["脾胃虚寒者慎用"],
        nutrition: { calories: 135, carbohydrates: 33.7, isoflavones: "含有" },
        commonUses: ["甘味", "サラダ", "鍋物"],
        preparationMethods: ["茹でる", "水で戻す"],
        bestSeasons: ["summer"],
        synergisticWith: [],
        conflictsWith: []
      },
      ...
      // け行継続
      {
        ...
        effects: ["補中益気", "健脾開胃"],
        contraindications: [],
        nutrition: { calories: 356, protein: 77.1, inosinic_acid: "高含有" },
        commonUses: ["だし", "ふりかけ", "お好み焼き"],
        preparationMethods: ["削る", "煎じる"],
        bestSeasons: ["all"],
        synergisticWith: [],
        conflictsWith: []
      },
      ...
      // こ行継続
      {
        ...
        effects: ["清熱解毒", "利水消腫"],
        contraindications: [],
        nutrition: { calories: 28, betaCarotene: 890, vitaminC: 27 },
        commonUses: ["天ぷら", "おひたし", "炒め物"],
        preparationMethods: ["茹でる", "炒める", "揚げる"],
        bestSeasons: ["spring"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        element: "metal",
        meridians: ["lung", "stomach"],
        effects: ["疏散風熱", "宣肺透疹", "解毒利咽"],
        contraindications: ["脾胃虚寒者慎用"],
        nutrition: { calories: 65, fiber: 5.7, potassium: 320, inulin: "含有" },
      ...
      },
      {
        ...
        effects: ["補肝腎", "益精血", "潤燥滑腸"],
        contraindications: ["便溏者慎用"],
        nutrition: { calories: 578, protein: 19.8, calcium: 1200, sesamin: "高含有" },
        commonUses: ["ごま塩", "すりごま", "お菓子"],
        preparationMethods: ["炒る", "擂り潰す", "すりつぶす"],
        bestSeasons: ["all"],
        synergisticWith: [],
        conflictsWith: []
      },
      {
        ...
        element: "water",
        meridians: ["stomach", "large_intestine"],
        effects: ["化痰消積", "解毒消腫", "通便"],
        contraindications: ["脾胃虚寒者慎用"],
        nutrition: { calories: 5, fiber: 2.2, glucomannan: "高含有" },
        commonUses: ["おでん", "煮物", "刺身"],
        preparationMethods: ["茹でる", "煮る"],
        bestSeasons: ["winter"],
        synergisticWith: [],
        conflictsWith: []
      },
